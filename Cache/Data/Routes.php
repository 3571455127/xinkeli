...
'/^(en)$/' => 'Index/index?l=:1',
'/^(en)\/([\w^_]+)_(\d+)-(\d+)$/' => 'Urlrule/show?l=:1&catdir=:2&id=:3&p=:4&',
'/^([\w^_]+)_(\d+)-(\d+)$/' => 'Urlrule/show?catdir=:1&id=:2&p=:3&',
'/^(en)\/([\w^_]+)_(\d+)$/' => 'Urlrule/show?l=:1&catdir=:2&id=:3&',
'/^([\w^_]+)_(\d+)$/' => 'Urlrule/show?catdir=:1&id=:2&',
'/^(en)\/([\w^_]+)-(\d+)$/' => 'Urlrule/index?l=:1&catdir=:2&p=:3&',
'/^([\w^_]+)-(\d+)$/' => 'Urlrule/index?catdir=:1&p=:2&',
'/^(en)\/([\w^_]+)$/' => 'Urlrule/index?l=:1&catdir=:2&',
